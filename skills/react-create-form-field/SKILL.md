...
- [architecture.md](architecture/react-hook-form/architecture.md#3-the-withreacthookform-higher-order-component)
...
- [architecture.md](architecture/react-hook-form/architecture.md#4-wrapping-base-components)
...
5. Consult the [Visual Reference for Components Layout & Highlighting](architecture/react-hook-form/architecture.md#visual-reference-for-components-layout--highlighting) to ensure component borders, text, spacing, and error highlightings match the spec's showcase screenshots.
...
- [architecture.md](architecture/react-hook-form/architecture.md#6-testing-form-field-components-storybook)
